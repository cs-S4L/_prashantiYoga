<form id="cmsEdit" action="<?=BASE_URL ?>cmsEdit/processEdit.php" method="POST">
	...
	<textarea name="adress" rows="6"><?=$this->adress?></textarea>

	<label for="heading">Location Homepage:</label>
	<input type="text" name="homepageUrl" value="<?=$this->homepageUrl?>">

	<label for="heading">Maps Url:</label>
	<input type="text" name="mapsUrl" value="<?=$this->mapsUrl?>">
